...
('1AM17CS102', 'CSE', 5, 'A', '987665432', 'Kanye West'),
('1AM17CS103', 'CSE', 5, 'B', '6325418596', 'Agnese Obel'),
...
--
ALTER TABLE `coordinators`
  ADD CONSTRAINT `coordinators_ibfk_!` FOREIGN KEY (`USN`) REFERENCES `students` (`USN`) ON DELETE CASCADE ON UPDATE RESTRICT;
